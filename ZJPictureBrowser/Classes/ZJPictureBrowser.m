...
#define picturePadding 10
#define durationTime 0.35
#define screenScale screenWidth / screenHeight

#import "ZJPictureBrowser.h"
#import "ZJPictureBrowserCell.h"
#import "ZJGestureView.h"
#import "UIImageView+WebCache.h"

@interface ZJPictureBrowser () <UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation ZJPictureBrowser {
...
- (UIImage *)currentImage{
    ZJPictureBrowserCell *cell = [_collectionView.visibleCells firstObject];
...
- (instancetype)init{
    if (self = [super init]) {
        self.counterStyle = pictureBrowserCounterStyleLabel;
...
- (void)createColloctionView{
    ...
    layout.minimumLineSpacing = picturePadding;
    ...
    [_collectionView registerClass:[ZJPictureBrowserCell class] forCellWithReuseIdentifier:@"reUsedCell"];
...
- (void)setCounterWithTag:(NSInteger)tag totalCount:(NSInteger)count{
    switch (_counterStyle) {
        case pictureBrowserCounterStyleLabel:
        ...
        case pictureBrowserCounterStylePageControl:
...
- (void)show{
    ...
    CGFloat offsetY = _currentIndex * (screenWidth + picturePadding);
...
- (void)singleTapScreen{
    ...
    ZJPictureBrowserCell *cell = [self.collectionView.visibleCells firstObject];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ZJPictureBrowserCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"reUsedCell" forIndexPath:indexPath];
...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(inout CGPoint *)targetContentOffset{
    ...
    float pageWidth = self.collectionView.frame.size.width + picturePadding; // width + space
...
+ (instancetype)browser{
    ZJPictureBrowser *browser = [[self alloc] init];
    return browser;
}
